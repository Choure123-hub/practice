...
public class example4_WithDDF2 {
public static void main(String[] args) throws InterruptedException, EncryptedDocumentException, IOException {
	...
	driver.findElement(By.xpath("//input[@id='mobileNo']")).sendKeys(sh.getRow(0).getCell(0).getStringCellValue());
	...
	driver.findElement(By.xpath("//label[@class='toggle-sidebar-menu-trigger']")).click();
	driver.findElement(By.xpath("//img[@class='logo-small']")).click();
